...
const Sidebar = () => {
  ...
  return (
    <div className="hidden h-full overflow-y-scroll border-r border-gray-900 p-5 pb-36 text-xs text-gray-500 scrollbar-hide sm:max-w-[12rem] md:block lg:max-w-[15rem] lg:text-sm">
